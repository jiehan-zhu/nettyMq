...
import com.pearadmin.common.web.interceptor.annotation.DataScope;
import com.pearadmin.common.web.interceptor.annotation.DataScopeRule;
...
public class DataScopeInterceptor implements Interceptor {
    ...
    private List<Scope> getScope(List<SysRole> roles) {
        return roles.stream().map(SysRole::getDataScope).collect(Collectors.toList());
    }
    ...
    private List<Scope> getScope(List<SysRole> roles, DataScopeRule[] rules) {
        ...
        for (SysRole role : roles) {
            for (DataScopeRule rule:rules) {
                if(role.getRoleCode().equals(rule.role())) {
