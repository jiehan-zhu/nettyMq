...
import com.pearadmin.modules.mq.service.impl.MqCommonRegistryServiceImpl;
...
public class NettyMqBrokerImpl implements NettyMqBroker, InitializingBean, DisposableBean {
    ...
    public void initServer() throws Exception {
        ...
        MqCommonRegistryData data = new MqCommonRegistryData();
        data.setKey(NettyMqBroker.class.getName());
        data.setValue(address);
        MqCommonRegistryServiceImpl.staticRegistryData = data;
